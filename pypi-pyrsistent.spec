...
Source0  : https://files.pythonhosted.org/packages/19/fb/845ff3b943ede86c69e62c9b47c0e796838552de38fc93d2048fc65ba161/pyrsistent-0.19.1.tar.gz
...
%prep
%setup -q -n pyrsistent-0.19.1
cd %{_builddir}/pyrsistent-0.19.1
%patch1 -p1
pushd ..
cp -a pyrsistent-0.19.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667227868
